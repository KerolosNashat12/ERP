...
const dictionary = {
  en: {
    ...
    filterGender: 'Shop for',
    genderWomen: 'Women', genderMen: 'Men', genderUnisex: 'Unisex',
    filterOffers: 'Offers',
    filterOnSale: 'On sale',
    filterPrice: 'Price',
    filterMinPrice: 'Lowest price', filterMaxPrice: 'Highest price',
    filterPriceNote: (min, max) => `Between ${min} and ${max}`,
    showResults: (n) => (n === 1 ? 'Show 1 product' : `Show ${n} products`),
    priceUnder: (amount) => `Under ${amount}`,
    priceOver: (amount) => `${amount} and up`,
    filterAvailability: 'Availability',
    filterInStock: 'In stock now',
    noMatchesTitle: 'Nothing matches all of that',
    noMatchesBody: 'Try removing a filter — the shop may have it in another size or another price.',
    priceWasNow: (was, now, off) => `Was ${was}, now ${now} — ${off}% off`,
    saveOff: (off) => `${off}% off`,
    ...
    payOnlineLong: "You'll be taken to a secure payment page to finish paying. Your order is reserved as soon as you place it, whether or not payment succeeds.",
    payOnlineFoot: "You'll pay on the next screen.",
    ...
    paymentPaid: 'Paid online — thank you.',
    paymentPending: "We haven't received confirmation of your payment yet. If you completed it, this will update shortly — if not, you can still pay when your order arrives.",
    paymentFailed: "Your online payment didn't go through, so this order is on hold. Please contact us, or place a new order and pay on delivery instead.",
  ...
  ar: {
    ...
    filterGender: 'المنتج لمين',
    genderWomen: 'حريمي', genderMen: 'رجالي', genderUnisex: 'للجنسين',
    filterOffers: 'العروض',
    filterOnSale: 'عليه خصم',
    filterPrice: 'السعر',
    filterMinPrice: 'أقل سعر', filterMaxPrice: 'أعلى سعر',
    filterPriceNote: (min, max) => `من ${min} لـ ${max}`,
    showResults: (n) => (n === 1 ? 'اعرض منتج واحد' : `اعرض ${n} منتج`),
    priceUnder: (amount) => `أقل من ${amount}`,
    priceOver: (amount) => `${amount} وأكتر`,
    filterAvailability: 'التوفر',
    filterInStock: 'متوفر دلوقتي',
    noMatchesTitle: 'مفيش حاجة بكل الشروط دي',
    noMatchesBody: 'جرّب تشيل فلتر — يمكن يكون موجود بمقاس تاني أو بسعر تاني.',
    priceWasNow: (was, now, off) => `كان ${was}، بقى ${now} — خصم ${off}٪`,
    saveOff: (off) => `خصم ${off}٪`,
    ...
    payOnlineLong: 'هننقلك لصفحة دفع آمنة تكمّل فيها الدفع. طلبك بيتحجز أول ما تأكده، سواء الدفع نجح أو لأ.',
    payOnlineFoot: 'هتدفع في الخطوة الجاية.',
    ...
    paymentPaid: 'اتدفع أونلاين — شكرًا ليك.',
    paymentPending: 'لسه مأكدناش استلام الدفع بتاعك. لو دفعت فعلاً، هيتحدّث قريّب — ولو لأ، لسه تقدر تدفع لما الطلب يوصلك.',
    paymentFailed: 'الدفع الأونلاين بتاعك معملش، فالطلب ده متوقف دلوقتي. كلمنا، أو اعمل طلب جديد وادفع عند الاستلام بدل كده.',
